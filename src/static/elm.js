...
var author$project$Main$UpdateZipper = function (a) {
	return {$: 'UpdateZipper', a: a};
};
...
var author$project$Main$expect = F2(
...
var author$project$Main$initNode = {cid: 'QmPZqBbCpVNQhrCoEWPGEx3ZxAQDCxmiSN216nGs1RHGHN', id: 0, name: 'ROOT', size: 0, status: author$project$Main$Completed, title: ''};
var author$project$Main$ipfsApiUrl = 'http://localhost:5001/api/v0/';
...
var author$project$Main$ObjectStat = F6(
	function (hash, numLinks, blockSize, linksSize, dataSize, cumulativeSize) {
		return {blockSize: blockSize, cumulativeSize: cumulativeSize, dataSize: dataSize, hash: hash, linksSize: linksSize, numLinks: numLinks};
	});
var elm$json$Json$Decode$int = _Json_decodeInt;
var elm$json$Json$Decode$string = _Json_decodeString;
var elm$json$Json$Decode$succeed = _Json_succeed;
var author$project$Main$objectStatDecoder = A3(
			...
			A3(
				...
				A3(
					...
					A3(
						...
						elm$json$Json$Decode$succeed(author$project$Main$ObjectStat)))))));
...
var author$project$Main$getStats = function (hash) {
	return A2(
		elm$core$Task$andThen,
		function (stat) {
			return elm$core$Task$succeed(
				_Utils_update(
					author$project$Main$initNode,
					{cid: stat.hash, size: stat.cumulativeSize}));
		},
		elm$http$Http$task(
			{
				...
				resolver: elm$http$Http$stringResolver(
					author$project$Main$expect(author$project$Main$objectStatDecoder)),
				timeout: elm$core$Maybe$Nothing,
				url: author$project$Main$ipfsApiUrl + ('object/stat?arg=' + hash)
			}));
};
var author$project$Main$ipfsRequest = F4(
	function (url, method, node, decoder) {
		return elm$http$Http$task(
			{
				...
				method: method,
				resolver: elm$http$Http$stringResolver(
					author$project$Main$expect(decoder)),
				timeout: elm$core$Maybe$Nothing,
				url: url
			});
	});
var author$project$Main$getData = function (node) {
	return A4(
		author$project$Main$ipfsRequest,
		author$project$Main$ipfsApiUrl + ('object/get?arg=' + node.cid),
		'GET',
		node,
...
var author$project$Main$Node = F6(
	function (name, cid, size, title, status, id) {
		return {cid: cid, id: id, name: name, size: size, status: status, title: title};
	});
var author$project$Main$nodeDecoder = function (node) {
	return A2(
				...
				A3(
					...
					A3(
						...
						A3(
							...
							'Name',
							elm$json$Json$Decode$string,
							elm$json$Json$Decode$succeed(author$project$Main$Node)))))));
};
var elm$json$Json$Decode$list = _Json_decodeList;
var author$project$Main$objectDecoder = function (node) {
	return A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'Data',
		elm$json$Json$Decode$string,
		A3(
			...
			elm$json$Json$Decode$list(
				author$project$Main$nodeDecoder(node)),
			elm$json$Json$Decode$succeed(author$project$Main$Object)));
};
...
var author$project$Main$getChildren = function (node) {
	...
	var objectGetRequest = function (x) {
		return A4(
			author$project$Main$ipfsRequest,
			author$project$Main$ipfsApiUrl + ('object/get?arg=' + x.cid),
			'GET',
			x,
			author$project$Main$objectDecoder(x));
	};
	return A2(
		elm$core$Task$andThen,
		function (object) {
					...
					A2(
						...
						function (link) {
							return A3(
								elm$core$Task$map2,
								updateTitle,
								elm$core$Task$succeed(link),
								author$project$Main$getData(link));
						},
						object.links)));
		},
		A2(
			elm$core$Task$andThen,
			objectGetRequest,
			author$project$Main$getStats(node.cid)));
};
...
var author$project$Main$getTree = F2(
	function (depth, tree) {
		var _n0 = !depth;
		if (_n0) {
			return elm$core$Task$succeed(tree);
		} else {
			return A2(
				elm$core$Task$andThen,
				function (list) {
					return elm$core$Task$succeed(
						A2(zwilias$elm_rosetree$Tree$replaceChildren, list, tree));
				},
				A2(
					elm$core$Task$andThen,
					function (x) {
						return elm$core$Task$sequence(
							A2(
								...
								function (child) {
									return A2(
										elm$core$Task$andThen,
										author$project$Main$getTree(depth - 1),
										author$project$Main$getChildren(
											zwilias$elm_rosetree$Tree$label(child)));
								},
								zwilias$elm_rosetree$Tree$children(x)));
					},
					author$project$Main$getChildren(
...
var author$project$Main$getNode = function (cid) {
	return A2(
		elm$core$Task$attempt,
		author$project$Main$UpdateZipper,
		A2(
			elm$core$Task$andThen,
			author$project$Main$getTree(2),
			A2(
				elm$core$Task$andThen,
				function (node) {
					return elm$core$Task$succeed(
						A2(zwilias$elm_rosetree$Tree$tree, node, _List_Nil));
				},
				author$project$Main$getStats(cid))));
};
var zwilias$elm_rosetree$Tree$singleton = function (v) {
	return A2(zwilias$elm_rosetree$Tree$Tree, v, _List_Nil);
};
var author$project$Main$initTree = A2(
	zwilias$elm_rosetree$Tree$tree,
	author$project$Main$initNode,
	_List_fromArray(
		[
...
var author$project$Main$initModel = {
	...
	path: _List_fromArray(
		[author$project$Main$initNode]),
	raw_dag: '',
	root: author$project$Main$initNode.cid,
	zipper: zwilias$elm_rosetree$Tree$Zipper$fromTree(author$project$Main$initTree)
};
...
var author$project$Main$File = F5(
	function (name, cid, size, mimetype, status) {
		return {cid: cid, mimetype: mimetype, name: name, size: size, status: status};
	});
var author$project$Main$Selected = {$: 'Selected'};
var author$project$Main$AddFile = function (a) {
	return {$: 'AddFile', a: a};
};
var author$project$Main$Link = F3(
	function (name, cid, size) {
		return {cid: cid, name: name, size: size};
	});
...
var elm_community$json_extra$Json$Decode$Extra$parseInt = A2(
	...
	elm$json$Json$Decode$string);
var author$project$Main$sizeDecoder = elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[elm$json$Json$Decode$int, elm_community$json_extra$Json$Decode$Extra$parseInt]));
var author$project$Main$fileLinkDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'Size',
	author$project$Main$sizeDecoder,
	A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'Hash',
		elm$json$Json$Decode$string,
		A3(
			...
			'Name',
			elm$json$Json$Decode$string,
			elm$json$Json$Decode$succeed(author$project$Main$Link))));
...
var author$project$Main$addText = function (text) {
	var body = elm$http$Http$multipartBody(
		_List_fromArray(
			[
				A2(elm$http$Http$stringPart, 'textpart', text)
			]));
	return elm$http$Http$post(
		{
			body: A2(elm$http$Http$stringBody, 'text/plain', text),
			expect: A2(elm$http$Http$expectJson, author$project$Main$AddFile, author$project$Main$fileLinkDecoder),
			url: author$project$Main$ipfsApiUrl + 'add'
		});
};
...
var zwilias$elm_rosetree$Tree$Zipper$reconstruct = F2(
	function (focus, c) {
		return A2(
			zwilias$elm_rosetree$Tree$tree,
			c.label,
			_Utils_ap(
				elm$core$List$reverse(c.before),
				_Utils_ap(
					_List_fromArray(
						[focus]),
					c.after)));
	...
	if (!_n1.b) {
		...
		return elm$core$Maybe$Just(
			zwilias$elm_rosetree$Tree$Zipper$Zipper(
				{
					crumbs: rest,
					focus: A2(zwilias$elm_rosetree$Tree$Zipper$reconstruct, zipper.focus, crumb)
				}));
	}
};
var author$project$Main$getPath = F2(
	function (zipper, acc) {
		getPath:
		while (true) {
			var appendLabel = A2(
			...
			if (_n0.$ === 'Just') {
				var parent = _n0.a;
				var $temp$zipper = parent,
					$temp$acc = appendLabel;
				zipper = $temp$zipper;
				acc = $temp$acc;
				continue getPath;
			} else {
...
var zwilias$elm_rosetree$Tree$Zipper$addCrumb = F2(
	function (crumb, _n0) {
		var zipper = _n0.a;
		return zwilias$elm_rosetree$Tree$Zipper$Zipper(
			_Utils_update(
				zipper,
				{
					crumbs: A2(elm$core$List$cons, crumb, zipper.crumbs)
				}));
	});
...
var zwilias$elm_rosetree$Tree$Zipper$withFocus = F2(
	function (focus, _n0) {
		var zipper = _n0.a;
		return zwilias$elm_rosetree$Tree$Zipper$Zipper(
			_Utils_update(
...
var zwilias$elm_rosetree$Tree$Zipper$firstChild = function (zipper) {
	var _n0 = zwilias$elm_rosetree$Tree$Zipper$children(zipper);
	if (!_n0.b) {
		return elm$core$Maybe$Nothing;
	} else {
		var c = _n0.a;
		...
		return elm$core$Maybe$Just(
			A2(
				zwilias$elm_rosetree$Tree$Zipper$addCrumb,
				{
					after: cs,
					before: _List_Nil,
					label: zwilias$elm_rosetree$Tree$Zipper$label(zipper)
				},
				A2(zwilias$elm_rosetree$Tree$Zipper$withFocus, c, zipper)));
	}
};
				...
				zwilias$elm_rosetree$Tree$Zipper$Zipper(
					{
						crumbs: A2(
							...
							_Utils_update(
								...
								{
									after: after,
									before: A2(elm$core$List$cons, zipper.focus, crumb.before)
								}),
							rest),
						focus: next
					}));
...
var zwilias$elm_rosetree$Tree$Zipper$root = function (_n0) {
	var zipper = _n0.a;
	var _n1 = zipper.crumbs;
	if (!_n1.b) {
		return zwilias$elm_rosetree$Tree$Zipper$Zipper(zipper);
	} else {
		var crumb = _n1.a;
		var rest = _n1.b;
		return zwilias$elm_rosetree$Tree$Zipper$root(
			zwilias$elm_rosetree$Tree$Zipper$Zipper(
				{
					crumbs: rest,
					focus: A2(zwilias$elm_rosetree$Tree$Zipper$reconstruct, zipper.focus, crumb)
...
var author$project$Main$update = F2(
	function (msg, model) {
		var defaultNode = function (hash) {
			return {cid: hash, id: 0, name: 'defaultLink', size: 0, status: author$project$Main$Completed, title: ''};
		};
		switch (msg.$) {
			case 'NoOp':
			...
			case 'UpdateFocus':
				var node = msg.a;
				var updatedLabel = _Utils_update(
					node,
					{title: model.data});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							zipper: A2(zwilias$elm_rosetree$Tree$Zipper$replaceLabel, updatedLabel, model.zipper)
						}),
					elm$core$Platform$Cmd$none);
			case 'GetPath':
				var node = msg.a;
				var focusedLabel = zwilias$elm_rosetree$Tree$Zipper$label(model.zipper);
				var completeFocusedLabel = A2(
					zwilias$elm_rosetree$Tree$Zipper$replaceLabel,
					_Utils_update(
						focusedLabel,
						{status: author$project$Main$Completed}),
					model.zipper);
				var newZipper = function () {
					var _n1 = A2(
						zwilias$elm_rosetree$Tree$Zipper$findFromRoot,
						function (x) {
							return _Utils_eq(x.id, node.id);
						},
					...
					if (_n1.$ === 'Just') {
						...
						return A2(
							zwilias$elm_rosetree$Tree$Zipper$mapLabel,
							function (label) {
								return _Utils_eq(label.id, node.id) ? _Utils_update(
									label,
									{status: author$project$Main$Selected}) : label;
							},
							x);
					} else {
						return model.zipper;
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							data: node.title,
							path: A2(author$project$Main$getPath, newZipper, _List_Nil),
							zipper: newZipper
						}),
					elm$core$Platform$Cmd$none);
			case 'GetNode':
				...
				return _Utils_Tuple2(
					model,
					author$project$Main$getNode(cid));
			case 'AddText':
				var text = msg.a;
				return _Utils_Tuple2(
					model,
					author$project$Main$addText(text));
			case 'ObjectPut':
				var value = msg.a;
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			case 'UpdateZipper':
				var result = msg.a;
				var indexedTree = function (tree) {
					return A2(
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{raw_dag: 'UPDATE ZIPPER TASK FAIL'}),
						elm$core$Platform$Cmd$none);
				}
			default:
				var response = msg.a;
				if (response.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								content: A2(elm$core$List$cons, file, model.content)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
...
var author$project$Main$GetNode = function (a) {
	return {$: 'GetNode', a: a};
};
...
var author$project$Main$darkGrey = function (alpha) {
	return A4(mdgriffith$elm_ui$Element$rgba255, 169, 169, 169, alpha);
};
var author$project$Main$lightGrey = function (alpha) {
	return A4(mdgriffith$elm_ui$Element$rgba255, 211, 211, 211, alpha);
};
...
var author$project$Main$viewControls = function (model) {
	var style = _List_fromArray(
		[
			...
			mdgriffith$elm_ui$Element$Border$width(1),
			mdgriffith$elm_ui$Element$Border$color(
			author$project$Main$darkGrey(1.0)),
			mdgriffith$elm_ui$Element$mouseOver(
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$Background$color(
					author$project$Main$lightGrey(1.0))
				]))
		]);
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						author$project$Main$GetNode(model.root))
					]),
				{
					label: A2(
						...
						mdgriffith$elm_ui$Element$text('Root Hash')),
					onChange: author$project$Main$UpdateQuery,
					placeholder: elm$core$Maybe$Just(
						A2(
							mdgriffith$elm_ui$Element$Input$placeholder,
							_List_Nil,
							mdgriffith$elm_ui$Element$text('Enter query hash here'))),
					text: model.root
				}),
				A2(
				...
				style,
				{
					label: mdgriffith$elm_ui$Element$text('obj put'),
				...
				style,
				{
					label: mdgriffith$elm_ui$Element$text('empty'),
					onPress: elm$core$Maybe$Just(author$project$Main$NoOp)
				}),
				A2(
				mdgriffith$elm_ui$Element$Input$button,
...
var author$project$Main$UpdateData = function (a) {
	return {$: 'UpdateData', a: a};
};
var author$project$Main$viewDataInput = function (data) {
	return A2(
		mdgriffith$elm_ui$Element$Input$text,
		_List_fromArray(
			[
				mdgriffith$elm_ui$Element$padding(5),
				mdgriffith$elm_ui$Element$Events$onLoseFocus(author$project$Main$NoOp)
			]),
		{
			label: A2(
				mdgriffith$elm_ui$Element$Input$labelLeft,
			...
			onChange: author$project$Main$UpdateData,
			placeholder: elm$core$Maybe$Just(
				A2(
					mdgriffith$elm_ui$Element$Input$placeholder,
					_List_Nil,
					mdgriffith$elm_ui$Element$text('Введите данные сюда'))),
			text: data
		});
};
var elm$core$Debug$toString = _Debug_toString;
var author$project$Main$viewNodeinPath = function (node) {
	return A2(
		mdgriffith$elm_ui$Element$Input$button,
		_List_fromArray(
			[
			...
			]),
		{
			label: mdgriffith$elm_ui$Element$text(
				node.name + ('(id: ' + (elm$core$Debug$toString(node.id) + ')/'))),
			onPress: elm$core$Maybe$Just(
				author$project$Main$GetNode(node.cid))
		});
};
var author$project$Main$viewPath = function (list) {
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		A2(elm$core$List$map, author$project$Main$viewNodeinPath, list));
};
var author$project$Main$blue = function (alpha) {
	return A4(mdgriffith$elm_ui$Element$rgba255, 62, 19, 175, alpha);
};
var author$project$Main$cyan = function (alpha) {
	return A4(mdgriffith$elm_ui$Element$rgba255, 2, 142, 155, alpha);
};
var author$project$Main$green = function (alpha) {
	return A4(mdgriffith$elm_ui$Element$rgba255, 152, 237, 0, alpha);
};
var author$project$Main$orange = function (alpha) {
	return A4(mdgriffith$elm_ui$Element$rgba255, 255, 122, 0, alpha);
};
...
var author$project$Main$viewCell = F2(
	function (tree, color) {
		var node = zwilias$elm_rosetree$Tree$label(tree);
		return A2(
			mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					_Utils_eq(node.status, author$project$Main$Selected) ? mdgriffith$elm_ui$Element$Background$color(
					author$project$Main$lightGrey(1.0)) : mdgriffith$elm_ui$Element$Background$color(color),
					mdgriffith$elm_ui$Element$Border$width(1),
					mdgriffith$elm_ui$Element$Border$color(
					author$project$Main$darkGrey(1.0)),
					...
					author$project$Main$GetPath(node)),
					mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill)
				]),
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[mdgriffith$elm_ui$Element$centerX]),
						mdgriffith$elm_ui$Element$text(
							elm$core$Debug$toString(node.id))),
						A2(
						mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[mdgriffith$elm_ui$Element$centerX]),
...
var author$project$Main$white = function (alpha) {
	return A4(mdgriffith$elm_ui$Element$rgba255, 255, 255, 255, alpha);
};
var mdgriffith$elm_ui$Element$none = mdgriffith$elm_ui$Internal$Model$Empty;
var author$project$Main$viewSector = F2(
	function (tree, color) {
		var childMap = function (child) {
			var _n0 = elm$core$String$toInt(
				zwilias$elm_rosetree$Tree$label(child).name);
			if (_n0.$ === 'Just') {
				var _int = _n0.a;
				return A2(
					mdgriffith$elm_ui$Element$row,
						...
						A2(
							...
							function (x) {
								return A2(
									author$project$Main$viewCell,
									x,
									(!_int) ? author$project$Main$white(1.0) : color);
							},
							zwilias$elm_rosetree$Tree$children(child))));
			} else {
...
var author$project$Main$violet = function (alpha) {
	return A4(mdgriffith$elm_ui$Element$rgba255, 210, 0, 107, alpha);
};
var author$project$Main$yellow = function (alpha) {
	return A4(mdgriffith$elm_ui$Element$rgba255, 255, 214, 0, alpha);
};
var author$project$Main$viewTable = function (tree) {
	var color = function (i) {
		switch (i) {
			case 0:
				return author$project$Main$yellow;
			case 1:
				return author$project$Main$orange;
			case 2:
				return author$project$Main$violet;
			case 3:
				return author$project$Main$cyan;
			case 4:
	...
	var childMap = function (child) {
		...
		if (_n0.$ === 'Just') {
			var _int = _n0.a;
			return A2(
				author$project$Main$viewSector,
				child,
				A2(color, _int, alpha));
		} else {
			return mdgriffith$elm_ui$Element$none;
				...
				A2(
					...
					_List_fromArray(
						[
							...
							author$project$Main$viewPath(model.path),
							author$project$Main$viewDataInput(model.data),
							author$project$Main$viewTable(
							zwilias$elm_rosetree$Tree$Zipper$toTree(
								zwilias$elm_rosetree$Tree$Zipper$root(model.zipper)))
						])))
			]),
...
var author$project$Main$main = elm$browser$Browser$document(
	{
		init: function (_n0) {
			return _Utils_Tuple2(
				...
				author$project$Main$getNode(author$project$Main$initNode.cid));
		},
