...
var _user$project$Models$Model = F6(
	function (a, b, c, d, e, f) {
		return {object: a, hash: b, data: c, headers: d, raw_dag: e, path: f};
	});
var _user$project$Models$Object = F2(
	function (a, b) {
		return {data: a, links: b};
	});
var _user$project$Models$Link = F3(
	function (a, b, c) {
		return {name: a, hash: b, size: c};
	});
var _user$project$Models$Header = function (a) {
	return {hash: a};
};
var _user$project$Models$ModifiedObject = F2(
	function (a, b) {
		return {hash: a, links: b};
	});
var _user$project$Models$File = {ctor: 'File'};
var _user$project$Models$Folder = {ctor: 'Folder'};

var _user$project$Msgs$DagHash = function (a) {
	return {ctor: 'DagHash', _0: a};
};
var _user$project$Msgs$DagPut = function (a) {
	return {ctor: 'DagPut', _0: a};
};
var _user$project$Msgs$DagGet = function (a) {
	return {ctor: 'DagGet', _0: a};
};
var _user$project$Msgs$UpdatePureData = function (a) {
	return {ctor: 'UpdatePureData', _0: a};
};
var _user$project$Msgs$GetIpfsHash = function (a) {
	return {ctor: 'GetIpfsHash', _0: a};
};
var _user$project$Msgs$GetObject = function (a) {
	return {ctor: 'GetObject', _0: a};
};
var _user$project$Msgs$GetModifiedObject = function (a) {
	return {ctor: 'GetModifiedObject', _0: a};
};
var _user$project$Msgs$AddLink = F2(
	function (a, b) {
		return {ctor: 'AddLink', _0: a, _1: b};
	});
var _user$project$Msgs$RemoveLink = function (a) {
	return {ctor: 'RemoveLink', _0: a};
};
var _user$project$Msgs$SetDataRequest = {ctor: 'SetDataRequest'};
var _user$project$Msgs$GetObjectRequest = F2(
	function (a, b) {
		return {ctor: 'GetObjectRequest', _0: a, _1: b};
	});
var _user$project$Msgs$UpdateData = function (a) {
	return {ctor: 'UpdateData', _0: a};
};
var _user$project$Msgs$UpdateQuery = function (a) {
	return {ctor: 'UpdateQuery', _0: a};
};

var _user$project$Commands$headerDecoder = A2(
	...
	A3(
		...
		'Ipfs-Hash',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Models$ModifiedObject)));
...
var _user$project$Commands$objectDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'Links',
	_user$project$Commands$linksDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'Data',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Models$Object)));
var _user$project$Commands$objectModifiedDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'Links',
	_user$project$Commands$linksDecoder,
	A3(
		...
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Models$ModifiedObject)));
var _user$project$Commands$onlyHashDecoder = A2(_elm_lang$core$Json_Decode$field, 'Hash', _elm_lang$core$Json_Decode$string);
var _user$project$Commands$stringtoBody = function (value) {
	return A2(_elm_lang$http$Http$stringBody, 'text/plain', value);
};
var _user$project$Commands$getHeader = function (response) {
	return A2(
		_elm_lang$core$Result$fromMaybe,
		'ipfs header not found',
		A2(
			_elm_lang$core$Dict$get,
			'ipfs-hash',
			A2(_elm_lang$core$Debug$log, 'headers', response.headers)));
};
var _user$project$Commands$put = F2(
	function (url, text) {
		return _elm_lang$http$Http$request(
			{
				method: 'PUT',
				headers: {ctor: '[]'},
				url: url,
				body: _user$project$Commands$stringtoBody(text),
				expect: _elm_lang$http$Http$expectStringResponse(_user$project$Commands$getHeader),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			});
	});
var _user$project$Commands$pathUpdate = F3(
	function (node, acc, path) {
		pathUpdate:
		while (true) {
			var _p0 = path;
			if (_p0.ctor === '::') {
				var _p2 = _p0._0;
				var _p1 = _elm_lang$core$Native_Utils.eq(_p2, node);
				if (_p1 === true) {
					return A2(
						_elm_lang$core$Basics_ops['++'],
						acc,
...
var _user$project$Commands$pathForUrl = function (path) {
	return A3(
		_elm_lang$core$List$foldr,
		F2(
			function (_p3, list) {
...
var _user$project$Commands$ipfsGatewayUrl = 'http://localhost:8080/ipfs/';
var _user$project$Commands$setData = F2(
	function (data, hash) {
		return A2(
			_elm_lang$core$Platform_Cmd$map,
			_user$project$Msgs$GetIpfsHash,
			_krisajenkins$remotedata$RemoteData$sendRequest(
				A2(
					_user$project$Commands$put,
					A2(_elm_lang$core$Basics_ops['++'], _user$project$Commands$ipfsGatewayUrl, hash),
					data)));
	});
var _user$project$Commands$ipfsApiUrl = 'http://localhost:5001/api/v0/';
var _user$project$Commands$dagGet = function (hash) {
	return A2(
		_elm_lang$core$Platform_Cmd$map,
		_user$project$Msgs$UpdatePureData,
		_krisajenkins$remotedata$RemoteData$sendRequest(
			_elm_lang$http$Http$getString(
				A2(
					_elm_lang$core$Basics_ops['++'],
					_user$project$Commands$ipfsApiUrl,
					A2(_elm_lang$core$Basics_ops['++'], 'dag/get?arg=', hash)))));
};
var _user$project$Commands$getObject = function (hash) {
	return A2(
		_elm_lang$core$Platform_Cmd$map,
		_user$project$Msgs$GetObject,
		_krisajenkins$remotedata$RemoteData$sendRequest(
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_user$project$Commands$ipfsApiUrl,
					A2(_elm_lang$core$Basics_ops['++'], 'object/get?arg=', hash)),
				_user$project$Commands$objectDecoder)));
};
var _user$project$Commands$removeLink = F2(
	function (hash, link) {
		return A2(
			_elm_lang$core$Platform_Cmd$map,
			_user$project$Msgs$GetModifiedObject,
			_krisajenkins$remotedata$RemoteData$sendRequest(
				A2(
					_elm_lang$http$Http$get,
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							'object/patch/rm-link?arg=',
							A2(
								_elm_lang$core$Basics_ops['++'],
								hash,
								A2(_elm_lang$core$Basics_ops['++'], '&arg=', link.name)))),
					_user$project$Commands$onlyHashDecoder)));
	});
var _user$project$Commands$addLink = F3(
	function (node_hash, name, link_hash) {
		return A2(
			_elm_lang$core$Platform_Cmd$map,
			_user$project$Msgs$GetModifiedObject,
			_krisajenkins$remotedata$RemoteData$sendRequest(
							...
							A2(
								...
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										link_hash,
										A2(_elm_lang$core$Basics_ops['++'], '&arg=', name)))))),
					_user$project$Commands$onlyHashDecoder)));
	});
...
var _user$project$Ports$receiveData = _elm_lang$core$Native_Platform.incomingPort('receiveData', _elm_lang$core$Json_Decode$string);
		...
		switch (_p0.ctor) {
			...
			case 'SetDataRequest':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_user$project$Commands$setData, model.data, model.hash)
				};
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							hash: _p1,
							path: A3(
								_user$project$Commands$pathUpdate,
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: _user$project$Commands$getObject(_p1),
							_1: {ctor: '[]'}
						})
				};
			case 'GetObject':
			...
			case 'GetModifiedObject':
				var ipfs_hash = A2(_krisajenkins$remotedata$RemoteData$withDefault, '', _p0._0);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: _user$project$Commands$getObject(ipfs_hash),
							_1: {
								ctor: '::',
								_0: _user$project$Commands$dagGet(ipfs_hash),
								_1: {ctor: '[]'}
							}
						})
				};
			case 'GetIpfsHash':
				var _p3 = _p0._0;
				var ipfs_hash = A2(_krisajenkins$remotedata$RemoteData$withDefault, '', _p3);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{headers: _p3, hash: ipfs_hash}),
					_1: _user$project$Commands$getObject(ipfs_hash)
				};
			case 'UpdatePureData':
				return {
					ctor: '_Tuple2',
			...
			case 'RemoveLink':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_user$project$Commands$removeLink, model.hash, _p0._0)
				};
			case 'AddLink':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A3(_user$project$Commands$addLink, model.hash, _p0._0, _p0._1)
				};
			case 'DagGet':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Commands$dagGet(_p0._0)
				};
			case 'DagPut':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Ports$sendData(_p0._0)
				};
			default:
				return {
					ctor: '_Tuple2',
...
var _user$project$View$maybeRemote = F2(
	function (viewFunction, response) {
		var _p0 = response;
		switch (_p0.ctor) {
			case 'NotAsked':
				return _mdgriffith$style_elements$Element$text('');
			case 'Loading':
				return _mdgriffith$style_elements$Element$text('Loading...');
			case 'Success':
				return viewFunction(_p0._0);
			default:
				return _mdgriffith$style_elements$Element$text(
					_elm_lang$core$Basics$toString(_p0._0));
		}
	});
var _user$project$View$findLinkByName = F2(
	function (link_name, object) {
		var _p1 = _krisajenkins$remotedata$RemoteData$toMaybe(object);
		if (_p1.ctor === 'Just') {
			return _elm_lang$core$List$head(
				A2(
					_elm_lang$core$List$filter,
					function (link) {
						return _elm_lang$core$Native_Utils.eq(link.name, link_name);
					},
					_p1._0.links));
		} else {
			return _elm_lang$core$Maybe$Nothing;
...
var _user$project$View$DagJson = {ctor: 'DagJson'};
var _user$project$View$Navigation = {ctor: 'Navigation'};
var _user$project$View$Button = {ctor: 'Button'};
var _user$project$View$Main = {ctor: 'Main'};
var _user$project$View$viewPath = function (path) {
	return A3(
		_mdgriffith$style_elements$Element$row,
						...
						_elm_lang$core$Basics_ops['++'],
						{
							...
							_0: A3(
								...
								_user$project$View$Navigation,
								{
									ctor: '::',
									_0: _mdgriffith$style_elements$Element_Events$onClick(
										A2(_user$project$Msgs$GetObjectRequest, _p4, _p3._1)),
									_1: {ctor: '[]'}
								},
								_mdgriffith$style_elements$Element$text(
...
var _user$project$View$viewRawDag = function (raw_dag) {
	return A3(
		_mdgriffith$style_elements$Element$column,
		_user$project$View$Main,
		{
		...
		},
		{
			...
			_0: A3(
				...
				{
					onChange: _user$project$Msgs$UpdateData,
					value: raw_dag,
					label: _mdgriffith$style_elements$Element_Input$placeholder(
						{
							label: _mdgriffith$style_elements$Element_Input$labelLeft(
								A3(
									...
									_mdgriffith$style_elements$Element$text('Data'))),
...
var _user$project$View$viewLink = function (link) {
	return A3(
		_mdgriffith$style_elements$Element$row,
		_user$project$View$Main,
		{
			...
			_0: A3(
				...
				_user$project$View$None,
				{
					...
					_1: {
						ctor: '::',
						_0: _mdgriffith$style_elements$Element_Events$onClick(
							A2(_user$project$Msgs$GetObjectRequest, link.name, link.hash)),
						_1: {ctor: '[]'}
					}
				},
				_mdgriffith$style_elements$Element$text(link.name)),
			_1: {
				ctor: '::',
				_0: A3(
					_mdgriffith$style_elements$Element$button,
					_user$project$View$None,
					{
						...
						_1: {
							ctor: '::',
							_0: _mdgriffith$style_elements$Element_Events$onClick(
								_user$project$Msgs$RemoveLink(link)),
							_1: {ctor: '[]'}
						}
					},
					_mdgriffith$style_elements$Element$text('Удалить')),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$View$viewObject = function (object) {
	return A3(
		_mdgriffith$style_elements$Element$column,
		_user$project$View$Main,
		{
		...
		A2(
			_elm_lang$core$List$map,
			function (link) {
				return _user$project$View$viewLink(link);
			},
			object.links));
};
var _user$project$View$viewControls = function (model) {
	return A3(
		_mdgriffith$style_elements$Element$row,
		_user$project$View$Main,
		{
		...
		},
		{
			...
			_0: A3(
				...
				{
					onChange: _user$project$Msgs$UpdateQuery,
					value: model.hash,
					label: _mdgriffith$style_elements$Element_Input$placeholder(
						{
							label: _mdgriffith$style_elements$Element_Input$labelLeft(
								A3(
									...
									_mdgriffith$style_elements$Element$text('Hash'))),
				...
				_0: A3(
					...
					_user$project$View$Button,
					{
						...
						_1: {
							ctor: '::',
							_0: _mdgriffith$style_elements$Element_Events$onClick(
								A2(_user$project$Msgs$GetObjectRequest, 'Home', model.hash)),
							_1: {ctor: '[]'}
						}
					},
					_mdgriffith$style_elements$Element$text('get object')),
				_1: {
					ctor: '::',
					_0: A3(
						_mdgriffith$style_elements$Element$button,
						_user$project$View$Button,
						{
							...
							_1: {
								ctor: '::',
								_0: _mdgriffith$style_elements$Element_Events$onClick(
									_user$project$Msgs$DagPut(model.data)),
								_1: {ctor: '[]'}
							}
						},
						_mdgriffith$style_elements$Element$text('set data')),
					_1: {
						ctor: '::',
						_0: A3(
							_mdgriffith$style_elements$Element$button,
							_user$project$View$Button,
							{
								...
								_1: {
									ctor: '::',
									_0: _mdgriffith$style_elements$Element_Events$onClick(
										_user$project$Msgs$DagGet(model.hash)),
									_1: {ctor: '[]'}
								}
							},
							_mdgriffith$style_elements$Element$text('dag get')),
						_1: {ctor: '[]'}
					}
				}
			}
					...
					_1: {
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: A2(_mdgriffith$style_elements$Style$prop, 'font-family', '\'Source Sans Pro\', \'Trebuchet MS\', \'Lucida Grande\', \'Bitstream Vera Sans\', \'Helvetica Neue\', sans-serif'),
									_1: {ctor: '[]'}
								}
							}
						}
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							_mdgriffith$style_elements$Style$style,
							_user$project$View$DagJson,
							{
								ctor: '::',
								_0: A2(_mdgriffith$style_elements$Style$prop, 'white-space', 'normal'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
		...
		A3(
			...
			},
			{
				...
				_0: A3(
					...
					_user$project$View$viewControls(model)),
				_1: {
					ctor: '::',
					_0: A3(
						_mdgriffith$style_elements$Element$row,
						...
						},
						{
							...
							_0: A3(
								...
								{
									ctor: '::',
									_0: _user$project$View$viewPath(model.path),
									_1: {
										ctor: '::',
										_0: A2(_user$project$View$maybeRemote, _user$project$View$viewObject, model.object),
										_1: {ctor: '[]'}
									}
								}),
							_1: {
								...
								_0: A3(
									...
									A2(_user$project$View$maybeRemote, _user$project$View$viewRawDag, model.raw_dag)),
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
...
var _user$project$Main$subscriptions = function (_p0) {
	return _user$project$Ports$receiveData(_user$project$Msgs$DagHash);
};
var _user$project$Main$initHash = 'QmaTTU7VZ3kD7Sz8ffrRVD7eLisDT8uJxgnNj92hcTZsFT';
var _user$project$Main$initModel = {
	object: _krisajenkins$remotedata$RemoteData$Loading,
	hash: _user$project$Main$initHash,
	data: '',
	headers: _krisajenkins$remotedata$RemoteData$NotAsked,
	raw_dag: _krisajenkins$remotedata$RemoteData$Loading,
	path: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'Home', _1: _user$project$Main$initHash},
		_1: {ctor: '[]'}
	}
};
var _user$project$Main$init = {
	...
	_1: _user$project$Commands$getObject(_user$project$Main$initModel.hash)
};
